...
class AstrivisLocalGlobalRegistration(nn.Module):
    def __init__(
        self,
        k: int,
        acceptance_radius: float,
        ...
        Args:
            ...
            num_refinement_steps (int=5): number of refinement steps.
        """
        super(AstrivisLocalGlobalRegistration, self).__init__()
        self.k = k
        self.acceptance_radius = acceptance_radius
        self.mutual = mutual
        self.confidence_threshold = confidence_threshold
    ...
    def local_to_global_registration(self, ref_knn_points, src_knn_points, score_mat, corr_mat):
        ...
        if batch_size > 0:
            ...
            batch_aligned_src_corr_points = apply_transform(src_corr_points.unsqueeze(0), batch_transforms)
            print('ref_corr_points.shape : ', ref_corr_points.unsqueeze(0).shape)
            ...
            print('optimal_transformations_per_superpoint.values[0] : ', optimal_transformations_per_superpoint.values[0])
