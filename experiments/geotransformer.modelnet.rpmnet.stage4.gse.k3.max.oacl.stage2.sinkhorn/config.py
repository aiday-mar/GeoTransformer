...
_C.backbone.init_voxel_size = 0.009 # used to be 0.004 # 0.05, seems to change the number of keypoints potentially you can have
...
_C.coarse_matching.dual_normalization = False
