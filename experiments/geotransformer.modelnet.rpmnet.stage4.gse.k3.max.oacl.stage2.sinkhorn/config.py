...
_C.model.num_points_in_patch = 3 # the number of points inside of the neighborhood in a center
...
_C.coarse_matching.num_correspondences = 1000 # 2000 # presumably the number of centers, previously this was 128
